...
public class FragmentOgle extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReferenceFromUrl("https://fitness-cee61-default-rtdb.firebaseio.com/");
        ...
        Query query=databaseReference.child("Ogle");
